...
let website = "/csrf-owin"

let githubLink = "http://github.com/exira/csrf-owin"

// Specify more information about your project
let info =
  [ "project-name", "csrf-owin"
    "project-author", "exira"
    "project-summary", "Exira.CsrfValidation.Owin is an OWIN middleware to prevent CSRF attacks by validating HTTP Headers and Cookies."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.CsrfValidation.Owin" ]
